(() => {
  ...
  const copy = {
    en: {
      ...
      keyGuide: {
        metaTitle: "How to get a key | Fima Macro",
        close: "Close key guide",
        eyebrow: "License guide",
        title: "How to get your FIMA key",
        description: "Use this page when the app asks where to get a key. Choose a plan, finish checkout, copy your masked license from Fima, then paste it into the app once. Never buy from fake links or share your full key.",
        choosePlan: "Choose a plan",
        openProducts: "Open My Products",
        downloadApp: "Download app",
        quickChecklist: "Quick checklist",
        check1Title: "Buy, earn, or redeem.",
        check1Body: "Paid keys come from checkout. Activity Reward and gift keys appear in your account after they are granted or redeemed.",
        check2Title: "Copy from Fima only.",
        check2Body: "Use the success page or My Products. Keys are masked on-screen for privacy.",
        check3Title: "Paste into the app.",
        check3Body: "The app binds access to your account and device, then stores a safe entitlement instead of showing the full key again.",
        check4Title: "Need help?",
        check4Body: "If payment worked but the key is missing, contact support using masked order and key details only.",
        stepsTitle: "Step-by-step",
        stepsIntro: "These steps work for 3-day, monthly and lifetime access, gift or redeem keys, and Activity Rewards. The flow changes slightly depending on how you receive the key.",
        step1Title: "Go to Pricing",
        step1Body: "Open fimamacro.com/pricing, choose your plan, and start checkout. Do not use old SellAuth or unofficial links.",
        step2Title: "Finish checkout or redeem",
        step2Body: "Stripe opens for paid plans. Gift, redeem and Activity Reward flows stay inside your Fima account so the key is linked safely.",
        step3Title: "Copy your key",
        step3Body: "After checkout, use the success page or My Products. The page shows a masked key and a Copy button.",
        step4Title: "Activate in the app",
        step4Body: "Open FIMA MACRO, paste the key, and press Activate License. If your device changed, support can help with an HWID reset.",
        securityLabel: "Security note:",
        securityText: "Fima never needs your Roblox password, cookies, Discord token, or browser session token. Only enter your license key inside the official Fima app or website.",
        readSecurity: "Read security page",
        troubleTitle: "If something goes wrong",
        troubleIntro: "Most activation problems involve the account, payment, or device binding. Use masked details when asking for help.",
        trouble1Title: "I paid but cannot find my key",
        trouble1Body: "Open My Products. If it is still missing, contact support with the payment time and masked account information.",
        trouble2Title: "The app says the key belongs to another device",
        trouble2Body: "Your HWID may have changed. Ask support for a reset. Never post your full HWID or key in public channels.",
        trouble3Title: "The app asks me to validate again",
        trouble3Body: "Make sure you use the latest approved build. If it repeats, open a ticket and mention \"license refresh loop\".",
        footerText: "Official Fima license help. Keep your key private and use official links.",
        keyHelp: "Key help",
    ...
    tr: {
      ...
      keyGuide: {
        metaTitle: "Anahtar nasıl alınır? | Fima Macro",
        close: "Anahtar rehberini kapat",
        eyebrow: "Lisans rehberi",
        title: "FIMA anahtarını nasıl alırsın?",
        description: "Uygulama anahtarı nereden alacağını sorduğunda bu rehberi kullan. Bir plan seç, ödemeyi tamamla, maskelenmiş lisansını Fima'dan kopyala ve uygulamaya bir kez yapıştır. Sahte bağlantılardan satın alma ve tam anahtarını kimseyle paylaşma.",
        choosePlan: "Plan seç",
        openProducts: "Ürünlerimi aç",
        downloadApp: "Uygulamayı indir",
        quickChecklist: "Hızlı kontrol listesi",
        check1Title: "Satın al, kazan veya kullan.",
        check1Body: "Ücretli anahtarlar ödeme sonrasında gelir. Etkinlik Ödülü ve hediye anahtarları verildikten ya da kullanıldıktan sonra hesabında görünür.",
        check2Title: "Yalnızca Fima'dan kopyala.",
        check2Body: "Başarı sayfasını veya Ürünlerim bölümünü kullan. Gizlilik için anahtarlar ekranda maskelenir.",
        check3Title: "Uygulamaya yapıştır.",
        check3Body: "Uygulama erişimi hesabına ve cihazına bağlar, ardından tam anahtarı yeniden göstermek yerine güvenli bir yetki kaydı saklar.",
        check4Title: "Yardıma mı ihtiyacın var?",
        check4Body: "Ödeme başarılı olduğu hâlde anahtar yoksa yalnızca maskelenmiş sipariş ve anahtar bilgileriyle desteğe ulaş.",
        stepsTitle: "Adım adım",
        stepsIntro: "Bu adımlar 3 günlük, aylık ve ömür boyu erişim; hediye veya kullanım anahtarları ve Etkinlik Ödülleri için geçerlidir. Akış, anahtarı nasıl aldığına göre biraz değişebilir.",
        step1Title: "Fiyatlar sayfasına git",
        step1Body: "fimamacro.com/pricing adresini aç, planını seç ve ödemeyi başlat. Eski SellAuth veya resmî olmayan bağlantıları kullanma.",
        step2Title: "Ödemeyi veya anahtar kullanımını tamamla",
        step2Body: "Ücretli planlarda Stripe açılır. Hediye, kullanım ve Etkinlik Ödülü işlemleri anahtarın güvenle bağlanması için Fima hesabının içinde kalır.",
        step3Title: "Anahtarını kopyala",
        step3Body: "Ödeme sonrasında başarı sayfasını veya Ürünlerim bölümünü kullan. Sayfada maskelenmiş anahtar ve Kopyala düğmesi gösterilir.",
        step4Title: "Uygulamada etkinleştir",
        step4Body: "FIMA MACRO'yu aç, anahtarı yapıştır ve Lisansı Etkinleştir düğmesine bas. Cihazın değiştiyse destek HWID sıfırlamasına yardımcı olabilir.",
        securityLabel: "Güvenlik notu:",
        securityText: "Fima hiçbir zaman Roblox şifreni, çerezlerini, Discord tokenini veya tarayıcı oturum tokenini istemez. Lisans anahtarını yalnızca resmî Fima uygulamasına veya sitesine gir.",
        readSecurity: "Güvenlik sayfasını aç",
        troubleTitle: "Bir sorun çıkarsa",
        troubleIntro: "Etkinleştirme sorunlarının çoğu hesap, ödeme veya cihaz bağlama kaynaklıdır. Yardım isterken maskelenmiş bilgiler kullan.",
        trouble1Title: "Ödeme yaptım ama anahtarımı bulamıyorum",
        trouble1Body: "Ürünlerim bölümünü aç. Anahtar hâlâ yoksa ödeme zamanı ve maskelenmiş hesap bilgileriyle desteğe ulaş.",
        trouble2Title: "Uygulama anahtarın başka bir cihaza ait olduğunu söylüyor",
        trouble2Body: "HWID'in değişmiş olabilir. Destekten sıfırlama iste. Tam HWID'ini veya anahtarını herkese açık kanallarda paylaşma.",
        trouble3Title: "Uygulama yeniden doğrulama istiyor",
        trouble3Body: "En güncel onaylı sürümü kullandığından emin ol. Sorun tekrarlanırsa bir destek talebi açıp \"license refresh loop\" yaz.",
        footerText: "Resmî Fima lisans yardımı. Anahtarını gizli tut ve yalnızca resmî bağlantıları kullan.",
        keyHelp: "Anahtar yardımı",
        successPage: "Başarı sayfası",
        trust: "Güven",
        security: "Güvenlik",
        officialDownload: "Resmî indirme"
      },
      footer: {
    ...
    de: {
      ...
      keyGuide: {
        metaTitle: "So erhältst du einen Schlüssel | Fima Macro",
        close: "Schlüsselanleitung schließen",
        eyebrow: "Lizenzanleitung",
        title: "So erhältst du deinen FIMA-Schlüssel",
        description: "Nutze diese Anleitung, wenn die App nach einem Schlüssel fragt. Wähle einen Plan, schließe die Zahlung ab, kopiere deine maskierte Lizenz bei Fima und füge sie einmal in die App ein. Kaufe nie über gefälschte Links und teile niemals deinen vollständigen Schlüssel.",
        choosePlan: "Plan auswählen",
        openProducts: "Meine Produkte öffnen",
        downloadApp: "App herunterladen",
        quickChecklist: "Schnellcheck",
        check1Title: "Kaufen, verdienen oder einlösen.",
        check1Body: "Bezahlte Schlüssel erscheinen nach dem Checkout. Aktivitätsbelohnungen und Geschenkschlüssel erscheinen nach Vergabe oder Einlösung in deinem Konto.",
        check2Title: "Nur bei Fima kopieren.",
        check2Body: "Nutze die Erfolgsseite oder Meine Produkte. Schlüssel werden zum Schutz deiner Daten maskiert angezeigt.",
        check3Title: "In die App einfügen.",
        check3Body: "Die App bindet den Zugriff an dein Konto und Gerät und speichert anschließend eine sichere Berechtigung, ohne den vollständigen Schlüssel erneut anzuzeigen.",
        check4Title: "Brauchst du Hilfe?",
        check4Body: "Wenn die Zahlung erfolgreich war, aber der Schlüssel fehlt, kontaktiere den Support nur mit maskierten Bestell- und Schlüsseldaten.",
        stepsTitle: "Schritt für Schritt",
        stepsIntro: "Diese Schritte gelten für 3-Tage-, Monats- und Lifetime-Zugriff, Geschenk- oder Einlöseschlüssel und Aktivitätsbelohnungen. Der Ablauf unterscheidet sich je nach Herkunft des Schlüssels leicht.",
        step1Title: "Zur Preisseite gehen",
        step1Body: "Öffne fimamacro.com/pricing, wähle deinen Plan und starte den Checkout. Nutze weder alte SellAuth- noch inoffizielle Links.",
        step2Title: "Checkout oder Einlösung abschließen",
        step2Body: "Für bezahlte Pläne öffnet sich Stripe. Geschenk-, Einlöse- und Aktivitätsbelohnungen bleiben in deinem Fima-Konto, damit der Schlüssel sicher verknüpft wird.",
        step3Title: "Schlüssel kopieren",
        step3Body: "Nutze nach dem Checkout die Erfolgsseite oder Meine Produkte. Dort siehst du einen maskierten Schlüssel und die Schaltfläche Kopieren.",
        step4Title: "In der App aktivieren",
        step4Body: "Öffne FIMA MACRO, füge den Schlüssel ein und klicke auf Lizenz aktivieren. Wenn sich dein Gerät geändert hat, hilft der Support beim HWID-Reset.",
        securityLabel: "Sicherheitshinweis:",
        securityText: "Fima benötigt niemals dein Roblox-Passwort, Cookies, Discord-Token oder Browser-Sitzungstoken. Gib deinen Lizenzschlüssel nur in der offiziellen Fima-App oder auf der offiziellen Website ein.",
        readSecurity: "Sicherheitsseite öffnen",
        troubleTitle: "Wenn etwas nicht funktioniert",
        troubleIntro: "Die meisten Aktivierungsprobleme betreffen Konto, Zahlung oder Gerätebindung. Nutze bei Supportanfragen nur maskierte Daten.",
        trouble1Title: "Ich habe bezahlt, finde aber meinen Schlüssel nicht",
        trouble1Body: "Öffne Meine Produkte. Fehlt der Schlüssel weiterhin, kontaktiere den Support mit Zahlungszeitpunkt und maskierten Kontodaten.",
        trouble2Title: "Die App meldet, der Schlüssel gehöre zu einem anderen Gerät",
        trouble2Body: "Deine HWID könnte sich geändert haben. Bitte den Support um einen Reset. Teile niemals deine vollständige HWID oder deinen Schlüssel öffentlich.",
        trouble3Title: "Die App verlangt erneut eine Validierung",
        trouble3Body: "Verwende die neueste freigegebene Version. Wiederholt sich das Problem, öffne ein Ticket und nenne \"license refresh loop\".",
        footerText: "Offizielle Fima-Lizenzhilfe. Halte deinen Schlüssel geheim und nutze offizielle Links.",
        keyHelp: "Schlüsselhilfe",
        successPage: "Erfolgsseite",
        trust: "Vertrauen",
        security: "Sicherheit",
    ...
    fr: {
      ...
      keyGuide: {
        metaTitle: "Comment obtenir une clé | Fima Macro",
        close: "Fermer le guide des clés",
        eyebrow: "Guide de licence",
        title: "Comment obtenir ta clé FIMA",
        description: "Utilise ce guide lorsque l'application demande où obtenir une clé. Choisis une offre, termine le paiement, copie ta licence masquée depuis Fima, puis colle-la une fois dans l'application. N'achète jamais via de faux liens et ne partage jamais ta clé complète.",
        choosePlan: "Choisir une offre",
        openProducts: "Ouvrir Mes produits",
        downloadApp: "Télécharger l'application",
        quickChecklist: "Vérification rapide",
        check1Title: "Acheter, gagner ou utiliser.",
        check1Body: "Les clés payantes arrivent après le paiement. Les récompenses d'activité et les clés cadeaux apparaissent dans ton compte après leur attribution ou leur utilisation.",
        check2Title: "Copier uniquement depuis Fima.",
        check2Body: "Utilise la page de confirmation ou Mes produits. Les clés sont masquées à l'écran pour protéger tes données.",
        check3Title: "Coller dans l'application.",
        check3Body: "L'application lie l'accès à ton compte et à ton appareil, puis conserve une autorisation sécurisée sans réafficher la clé complète.",
        check4Title: "Besoin d'aide ?",
        check4Body: "Si le paiement a réussi mais que la clé manque, contacte le support uniquement avec les détails masqués de la commande et de la clé.",
        stepsTitle: "Étape par étape",
        stepsIntro: "Ces étapes fonctionnent pour les accès de 3 jours, mensuels et à vie, les clés cadeaux ou à utiliser et les récompenses d'activité. Le parcours varie légèrement selon l'origine de la clé.",
        step1Title: "Aller à la page des prix",
        step1Body: "Ouvre fimamacro.com/pricing, choisis ton offre et lance le paiement. N'utilise pas les anciens liens SellAuth ni les liens non officiels.",
        step2Title: "Terminer le paiement ou l'utilisation",
        step2Body: "Stripe s'ouvre pour les offres payantes. Les cadeaux, utilisations et récompenses d'activité restent dans ton compte Fima afin de lier la clé en sécurité.",
        step3Title: "Copier ta clé",
        step3Body: "Après le paiement, utilise la page de confirmation ou Mes produits. La page affiche une clé masquée et un bouton Copier.",
        step4Title: "Activer dans l'application",
        step4Body: "Ouvre FIMA MACRO, colle la clé et appuie sur Activer la licence. Si ton appareil a changé, le support peut aider à réinitialiser le HWID.",
        securityLabel: "Note de sécurité :",
        securityText: "Fima ne demande jamais ton mot de passe Roblox, tes cookies, ton token Discord ou ton token de session du navigateur. Saisis ta clé uniquement dans l'application ou le site officiel Fima.",
        readSecurity: "Ouvrir la page de sécurité",
        troubleTitle: "En cas de problème",
        troubleIntro: "La plupart des problèmes d'activation concernent le compte, le paiement ou la liaison de l'appareil. Utilise des informations masquées lorsque tu demandes de l'aide.",
        trouble1Title: "J'ai payé mais je ne trouve pas ma clé",
        trouble1Body: "Ouvre Mes produits. Si elle manque toujours, contacte le support avec l'heure du paiement et des informations de compte masquées.",
        trouble2Title: "L'application indique que la clé appartient à un autre appareil",
        trouble2Body: "Ton HWID a peut-être changé. Demande une réinitialisation au support. Ne publie jamais ton HWID complet ni ta clé dans un canal public.",
        trouble3Title: "L'application redemande une validation",
        trouble3Body: "Vérifie que tu utilises la dernière version approuvée. Si le problème revient, ouvre un ticket et indique \"license refresh loop\".",
        footerText: "Aide officielle pour les licences Fima. Garde ta clé privée et utilise uniquement les liens officiels.",
        keyHelp: "Aide sur les clés",
        successPage: "Page de confirmation",
        trust: "Confiance",
        security: "Sécurité",
    ...
    bs: {
      ...
      keyGuide: {
        metaTitle: "Kako dobiti ključ | Fima Macro",
        close: "Zatvori vodič za ključ",
        eyebrow: "Vodič za licencu",
        title: "Kako dobiti svoj FIMA ključ",
        description: "Koristi ovaj vodič kada aplikacija pita gdje možeš dobiti ključ. Odaberi plan, završi plaćanje, kopiraj maskiranu licencu iz Fime i jednom je zalijepi u aplikaciju. Nikada ne kupuj preko lažnih linkova i ne dijeli cijeli ključ.",
        choosePlan: "Odaberi plan",
        openProducts: "Otvori Moje proizvode",
        downloadApp: "Preuzmi aplikaciju",
        quickChecklist: "Brza provjera",
        check1Title: "Kupi, osvoji ili iskoristi.",
        check1Body: "Plaćeni ključevi stižu nakon plaćanja. Nagrade za aktivnost i poklon-ključevi pojavljuju se na nalogu nakon dodjele ili korištenja.",
        check2Title: "Kopiraj samo iz Fime.",
        check2Body: "Koristi stranicu potvrde ili Moje proizvode. Ključevi su radi privatnosti maskirani na ekranu.",
        check3Title: "Zalijepi u aplikaciju.",
        check3Body: "Aplikacija veže pristup za tvoj nalog i uređaj, a zatim čuva sigurno ovlaštenje bez ponovnog prikaza cijelog ključa.",
        check4Title: "Treba ti pomoć?",
        check4Body: "Ako je plaćanje uspjelo, ali ključ nedostaje, kontaktiraj podršku samo s maskiranim podacima narudžbe i ključa.",
        stepsTitle: "Korak po korak",
        stepsIntro: "Ovi koraci važe za pristup od 3 dana, mjesečni i doživotni pristup, poklon-ključeve ili ključeve za korištenje i nagrade za aktivnost. Tok se malo razlikuje zavisno od izvora ključa.",
        step1Title: "Idi na Cijene",
        step1Body: "Otvori fimamacro.com/pricing, odaberi plan i pokreni plaćanje. Ne koristi stare SellAuth niti nezvanične linkove.",
        step2Title: "Završi plaćanje ili korištenje",
        step2Body: "Stripe se otvara za plaćene planove. Pokloni, korištenje i nagrade za aktivnost ostaju na Fima nalogu kako bi ključ bio sigurno povezan.",
        step3Title: "Kopiraj ključ",
        step3Body: "Nakon plaćanja koristi stranicu potvrde ili Moje proizvode. Stranica prikazuje maskirani ključ i dugme Kopiraj.",
        step4Title: "Aktiviraj u aplikaciji",
        step4Body: "Otvori FIMA MACRO, zalijepi ključ i pritisni Aktiviraj licencu. Ako se uređaj promijenio, podrška može pomoći s HWID resetom.",
        securityLabel: "Sigurnosna napomena:",
        securityText: "Fima nikada ne traži tvoju Roblox lozinku, kolačiće, Discord token ili token browser sesije. Licencni ključ unosi samo u zvaničnu Fima aplikaciju ili web-stranicu.",
        readSecurity: "Otvori sigurnosnu stranicu",
        troubleTitle: "Ako nešto pođe po zlu",
        troubleIntro: "Većina problema s aktivacijom odnosi se na nalog, plaćanje ili vezivanje uređaja. Pri traženju pomoći koristi maskirane podatke.",
        trouble1Title: "Platio sam, ali ne mogu pronaći ključ",
        trouble1Body: "Otvori Moje proizvode. Ako ključ i dalje nedostaje, kontaktiraj podršku s vremenom plaćanja i maskiranim podacima naloga.",
        trouble2Title: "Aplikacija kaže da ključ pripada drugom uređaju",
        trouble2Body: "Tvoj HWID se možda promijenio. Zatraži reset od podrške. Nikada javno ne objavljuj puni HWID ili ključ.",
        trouble3Title: "Aplikacija ponovo traži provjeru",
        trouble3Body: "Provjeri koristiš li najnoviju odobrenu verziju. Ako se problem ponavlja, otvori ticket i navedi \"license refresh loop\".",
        footerText: "Zvanična pomoć za Fima licence. Čuvaj ključ privatnim i koristi samo zvanične linkove.",
        keyHelp: "Pomoć za ključ",
        successPage: "Stranica potvrde",
        trust: "Povjerenje",
        security: "Sigurnost",
        officialDownload: "Zvanično preuzimanje"
      },
  ...
  const setText = () => {
    ...
    $$("[data-i18n-aria-label]").forEach((node) => {
      const value = readPath(activeCopy, node.dataset.i18nAriaLabel)
        ?? readPath(copy.en, node.dataset.i18nAriaLabel);
      if (typeof value === "string") {
