...
<body>
  ...
  <script>
    ...
    async function testLicense(){ const d=await post('/admin/api/licenses/validate',{licenseKey:toolLicense.value,hwid:toolHwid.value}); toolResult.textContent=JSON.stringify(d,null,2); }
