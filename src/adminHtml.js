...
<body>
  ...
  <script>
    ...
    function refreshCurrent(){
      const loader = ({dashboard:loadDashboard,products:loadProducts,users:loadUsers,purchases:loadPurchases,orders:loadOrders,licenses:loadLicenses,customers:loadCustomers,downloads:loadDownloads,settings:loadSettings,coupons:loadCoupons,referrals:loadReferrals,analytics:loadAnalytics,webhooks:loadWebhooks,audit:loadAudit,tools:loadTools}[current]);
