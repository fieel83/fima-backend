...
const requirements = [
  ...
  requirement("DASH-001", "Customer dashboard baseline", "Authorized login, top server selector, isolated routes, safe config save/reload, validation, toast and CSRF retry form the first dashboard proof.", {
    ...
    testRequirements: [...commonTest, "authorized browser save/reload", "CSRF retry", "two-guild isolation"], sourceStatus: "LOCAL VERIFIED", localTestStatus: "LOCAL VERIFIED", dashboardBrowserStatus: "BLOCKED", evidencePath: ["src/paradiseDashboardWorkspace.js", "src/server.js", "test/paradiseDashboardWorkspace.test.js", "test/paradise-dashboard.test.js"], blocker: "Owner-authenticated browser interaction not currently available.", nextExactAction: "Use an authorized customer browser session to verify save, reload, CSRF refresh/retry and responsive server switching; do not call local API tests dashboard proof.", affectedFiles: ["src/paradiseDashboardWorkspace.js", "src/server.js", "src/paradiseDashboardHtml.js", "public/dashboard.html"], securityRisk: "high"
  }),
